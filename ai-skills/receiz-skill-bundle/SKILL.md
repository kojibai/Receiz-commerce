...
For v120 authority-bearing artifact work, route through exact-byte verification, profile admission, runtime-custodied actor and history, transition planning, a plan-bound Identity Seal capability claim, sealing, durable neutral staging, independent staged-byte resolution, atomic named-domain acceptance, and a report-only receipt. AI routing is never authority.
