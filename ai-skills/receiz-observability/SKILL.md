...
description: Use when adding or reviewing logs, traces, metrics, diagnostics, incident evidence, audit records, or privacy-safe telemetry.
---

# receiz-observability

Emit lower-authority operational evidence keyed by command, receipt, tenant, laws, registry digest, and stable result code. Receiz is a proof-native artifact system; this skill operates beneath sealed proof and verified local history.

## Constitutional workflow

1. Inspect the repository and installed SDK version.
2. Load the active canonical v118 registry and applicable constitutional laws.
...
Focused outcome: Emit lower-authority operational evidence keyed by command, receipt, tenant, laws, registry digest, and stable result code.
...
Request: Emit lower-authority operational evidence keyed by command, receipt, tenant, laws, registry digest, and stable result code.
