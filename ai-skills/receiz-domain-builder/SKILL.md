...
description: Use when creating or extending a Receiz domain, aggregate, event model, projection, schema, or generated domain scaffold.
---

# receiz-domain-builder

Model aggregate identities, commands, events, projections, privacy classes, migrations, and tests as one registry-bound domain. Receiz is a proof-native artifact system; this skill operates beneath sealed proof and verified local history.
...
Focused outcome: Model aggregate identities, commands, events, projections, privacy classes, migrations, and tests as one registry-bound domain.
