...
description: Use when defining, versioning, explaining, covering, or changing executable Receiz laws and rulesets.
---
...
Focused outcome: Define deterministic predicates, stable denial codes, safe alternatives, version compatibility, and positive and negative fixtures.
...
Request: Define deterministic predicates, stable denial codes, safe alternatives, version compatibility, and positive and negative fixtures.
