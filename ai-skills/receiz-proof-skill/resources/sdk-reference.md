...
The v116 app compiler APIs (`defineReceizApp`, `compileReceizAppContract`, and
...
## V116 Native Profile, Artifact, And Ownership Outcomes
...
Stable obsolete-versioned schemas remain historical compatibility imports. Do not teach their key/head/receipt mechanics as the active v116 profile or bearer outcome. Historical bytes must be reverified and currently admitted; no historical runtime authority object crosses the boundary.
