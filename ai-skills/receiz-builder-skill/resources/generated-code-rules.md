...
- Never serialize or reconstruct current verified artifacts, admissions, histories, actors, plans, verified capabilities, candidates, or stores. Preserve same-runtime custody and cross-process boundaries only with exact bytes requiring reverification.
