...
description: Use when streaming a proof-grounded character with low-latency speech, audio, visemes, gaze, emotion, gesture, and structured intentions.
---

# receiz-live-proof-character

Stream bounded retrieval and response deltas from the complete proof head. Mark every animation instruction non-authoritative and keep canonical state intact on voice, model, or rendering failure.
...
Open a long-form proof object and let the person narrate it. Resolve the exact long-form bytes through the shared proof index and stream narration/performance without changing the proof object.
