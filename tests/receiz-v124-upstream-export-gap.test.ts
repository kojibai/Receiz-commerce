...
describe("Receiz v127.0.0 upstream streaming-verifier export gap", () => {
  it("records the confirmed package boundary as a private next-release requirement", () => {
    assert.equal(packageJson.version, "127.0.0");
    ...
    assert.equal(gap.observedPackage, "@receiz/sdk@127.0.0");
