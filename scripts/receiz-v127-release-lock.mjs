...
for (const script of ['receiz-v127-migration-verify.mjs','receiz-v127-inspection.mjs']) {
...
const tests=['receiz-v124-release-identity','receiz-v124-adapter','receiz-v124-production-runtime','receiz-v124-authority-scan','receiz-v124-developer-ui','receiz-v124-material-ui','receiz-v124-upstream-export-gap','receiz-app-contract','receiz-v123-proof-authority','receiz-v123-value-execution','receiz-v122-world','receiz-v126-inspection','receiz-v127-boundaries'];
...
console.log(JSON.stringify({schema:'receiz.app.v127.release-lock.v1',ok:checks.every(check=>check.ok),packageVersion:'127.0.0',checks},null,2));
