...
const commands = [
  ...
  { id: "app-check", command: process.execPath, args: [resolve(root, "scripts", "receiz-v127-inspection.mjs")], json: true },
  { id: "conformance", command: process.execPath, args: [cli, "conformance"], json: true },
  { id: "migration-verification", command: process.execPath, args: [resolve(root, "scripts", "receiz-v127-migration-verify.mjs"), "--root", root], json: true }
];
