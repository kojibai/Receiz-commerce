...
const commands = [
  ...
  { id: "app-check", command: process.execPath, args: [cli, "app", "check", "--target", "118.0.0", "--root", root, "--json"], json: true },
  { id: "conformance", command: process.execPath, args: [cli, "conformance"], json: true },
  { id: "migration-verification", command: process.execPath, args: [resolve(root, "scripts", "receiz-v118-migration-verify.mjs"), "--root", root], json: true }
];
